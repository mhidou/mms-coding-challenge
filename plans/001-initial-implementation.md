...
| Employee existence check | Deferred to step 6 (employees module) | `startOrder` currently assigns the given id; existence validation lands with the seeded collection |
